...
namespace JsonCons.JsonSchema
{
    ...
    class RegexValidator : IFormatValidator
    {
        ...
        internal RegexValidator(Regex pattern)
        {
            _pattern = pattern;
        }
    ...
    {
        internal static EmailValidator Instance {get;} = new EmailValidator();
    ...
    {
        internal static DateValidator Instance {get;} = new DateValidator();
    ...
    {
        internal static TimeValidator Instance {get;} = new TimeValidator();
    ...
    {
        internal static DateTimeValidator Instance {get;} = new DateTimeValidator();
    ...
    class HostnameValidator : IFormatValidator
    {
        ...
        internal static HostnameValidator Instance {get;} = new HostnameValidator();
    ...
    class Ipv4Validator : IFormatValidator
    {
        ...
        internal static Ipv4Validator Instance {get;} = new Ipv4Validator();
    ...
    {
        internal static Ipv6Validator Instance {get;} = new Ipv6Validator();
